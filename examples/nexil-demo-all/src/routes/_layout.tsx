    ...
    element(
      ...
      element(
        ...
        element(
          ...
          'NEXIL',
          element('span', { class: 'text-cyan-400' }, '·DEMO'),
        ),
        element(
          'nav',
          ...
          Link({
            href: '/',
            children: 'Home',
            class: 'rounded-lg px-3 py-1.5 hover:bg-slate-800 hover:text-white',
          }),
          Link({
            href: '/stores',
            children: 'Stores',
        ...
        element(
          ...
          element(
            'span',
            { class: 'rounded-full bg-cyan-500 px-2.5 py-1 text-xs font-bold text-slate-950' },
            '0.2.4',
          ),
        ),
      ),
      element(
        ...
        Link({
          href: '/stores',
          children: 'Stores',
          class: 'whitespace-nowrap rounded bg-slate-800 px-2 py-1',
        }),
        Link({
          href: '/shop',
          children: 'Shop',
    ...
    element(
      ...
      element(
        ...
        element(
          ...
          'Built with Nexil — HTML-first, resumable, zero-hydration.',
        ),
        element(
          'div',
