...
[x] Verify pnpm pack --dry-run tarball contents (dist/_, README.md, package.json) and packed package.json dependencies
[x] If workspace:_ leaks, change packages/create-nexil/package.json dependency @nexil/starter from workspace:* to ^0.0.1 (only this file) and re-verify
