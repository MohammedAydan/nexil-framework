...
create-nexil --version       # prints 0.1.0 (exit 0)
...
The v0.1.0 initializer provides intentionally different starting points while preserving `interactive` as the default template.
