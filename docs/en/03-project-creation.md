...
create-nexil --version       # prints 0.2.1 (exit 0)
...
The v0.2.1 initializer provides intentionally different starting points while preserving `interactive` as the default template.
