...
The supported initializer is `@nexis/create-nexis`. Use the published CLI or the workspace package when developing the framework itself.

```bash
pnpm dlx @nexis/create-nexis@1.0.0 my-site --yes --ts
cd my-site
pnpm install
pnpm dev
```
