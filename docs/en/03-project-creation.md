...
create-nexil --version       # prints 0.2.3  (exit 0)
...
The v0.2.3 initializer provides intentionally different starting points while preserving `interactive` as the default template.
