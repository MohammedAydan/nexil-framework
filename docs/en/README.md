...
This directory contains the complete English documentation for Nexis Framework `1.2.0`. It is written for developers who need to understand the framework internally, build production applications, test them, optimize them, secure them, and deploy them.
...
| Review v1.2.0 release scope and migration      | [next release notes](../releases/next.md)                                                      |
...
- [v1.2.0 release scope and migration notes](../releases/next.md)
