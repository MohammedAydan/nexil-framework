...
## Architecture Overview (v0.2.3)

Nexil is consolidated into **4 publishable packages**:

```text
@nexil/core (core framework engine: core, reactivity, state, jsx-runtime, client, server, router)
